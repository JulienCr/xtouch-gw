...
impl ControlMappingDB {
    ...
    fn parse_csv(csv_content: &str) -> Result<Self> {
        ...
        for result in reader.deserialize() {
            let mapping: ControlMapping = result
            ...
            // Add to groups
            groups.entry(mapping.group.clone())
                .or_default()
        ...
        info!("Loaded {} control mappings in {} groups", 
            mappings.len(), groups.len());
